...
class gsidiag:
    ...
    def __init__(self, path):
        """
        Initialize a GSI diagnostic file object
        INPUT:
            path : path to GSI netCDF diagnostic file
        """
...
class conventional(gsidiag):
    ...
    def __init__(self, path):
        ...
        INPUT:
            path   : path to conventional GSI diagnostic file
        RESULT:
...
class radiance(gsidiag):
    ...
    def __init__(self, path):
        ...
        INPUT:
            path   : path to radiance GSI diagnostic file
        RESULT:
            self   : GSIdiag object containing the path to extract data
        """
        super().__init__(path)
    ...
    def read_radiance_obs(self):
        """
        Reads the data from the satellite radiance diagnostic file during initialization.
        """
    ...
    def getData(self, dtype, channel=None, qcflag=None):
        """
        Given parameters, get the data from a satellite radiance
        diagnostic file.
        INPUT:
            dtype   : type of data to extract i.e. observation, O-F, O-A, H(x)
