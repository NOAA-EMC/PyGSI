...
#rad_instruments = ['abi','ahi','airs','amsr2','amsre_hig','amsre_low','amsre_mid',
#                   'amsua','amsub','atms','avhrr','cris','cris-fsr','gmi','goes_img',
#                   'hirs3','hirs4','iasi','mhs','saphir','seviri','sndrd1','sndrd2',
...
if __name__ == '__main__':
    ...
    ap.add_argument("-i", "--input", help="Path to GSI stat file", required=True)
    ap.add_argument("-c", "--cycle", help="YYYYMMDDHH analysis cycle", required=True)
    ap.add_argument("-p", "--plotdir", help="Path to output plot dir", default='./')
