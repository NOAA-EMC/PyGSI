...
def profile(
    ...
    bias = _np.nanmean(bias, axis=2) / n_dates
    rms = _np.nanmean(rms, axis=2) / n_dates
    ob_error = _np.nanmean(ob_error, axis=2) / n_dates
    std_dev = _np.nanmean(std_dev, axis=2) / n_dates
    spread = _np.nanmean(spread, axis=2) / n_dates
    total_spread = _np.nanmean(total_spread, axis=2) / n_dates
    cr = _np.nanmean(cr, axis=2) / n_dates
    ser = _np.nanmean(ser, axis=2) / n_dates
